...
export const products: Product[] = [
  // ZERO TURN MOWERS
  {
    ...
    imageUrl: '/images/ferris/300s.jpg',
    status: 'IN_STOCK',
  },
  {
    sku: '5902206',
  ...
  },
  {
    ...
    imageUrl: '/images/ferris/300r.jpg',
    status: 'IN_STOCK',
    tag: 'Best Value',
  },
  {
    ...
    imageUrl: '/images/ferris/is600.jpg',
    status: 'IN_STOCK',
    tag: 'Popular',
  },
  {
    ...
    msrp: 8909,
    description:
      'IS 600 with the Briggs & Stratton CXi engine option — same legendary suspension, more torque at a lower price.',
    features: [
      'Ferris patented suspension system',
  ...
  },
  {
    ...
    msrp: 10449,
    description:
      'The IS 700 steps up productivity with a 60" deck and 27 HP engine, backed by Ferris independent suspension.',
    features: [
    ...
    imageUrl: '/images/ferris/is700.jpg',
    status: 'IN_STOCK',
  },
  {
    sku: '5902180',
    ...
    imageUrl: '/images/ferris/isx2200.jpg',
    status: 'IN_STOCK',
    tag: 'Best Seller',
  },
  {
    ...
    features: [
      '40 HP Vanguard® Big Block EFI ETC engine',
      'Next-gen ForeFront™ suspension',
      'Dual commercial Hydro-Gear® ZT-5400 drive',
      '2-belt iCD™+ cutting system',
      '60" fabricated deck',
      'Up to 12 mph ground speed',
      'Electronic Fuel Injection with Oil Guard',
    ],
    imageUrl: '/images/ferris/isx3300.jpg',
    status: 'AVAILABLE_TO_ORDER',
    tag: 'Top of the Line',
  },
  {
    ...
    imageUrl: '/images/ferris/is6200.jpg',
    status: 'AVAILABLE_TO_ORDER',
  ...
  },
  {
    ...
    msrp: 16774,
    description:
      'The 60" SRS Z3X with Vanguard EFI power — built for large commercial properties that demand stand-on efficiency.',
    features: [
      '40 HP Vanguard™ EFI engine',
      'Ferris suspension platform',
      '60" commercial deck',
      'Heavy-duty commercial drive',
