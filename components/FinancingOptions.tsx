  ...
  return (
    <div className="bg-[#111] border border-gray-800 rounded-xl overflow-hidden mb-6">
      ...
      <div className="px-5 pt-5 pb-4 border-b border-gray-800">
        <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Dealer Financing</p>
      ...
      <div className="p-5">
        <div className="space-y-3">
          ...
          <p className="text-gray-600 text-xs mt-1">
            Rates shown are estimates based on qualified buyers. Actual terms subject to lender approval.
          </p>
          <Link
            href="/financing"
