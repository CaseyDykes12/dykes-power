...
function CatalogContent() {
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold mb-2">Ferris Mower Catalog</h1>
      <p className="text-gray-500 mb-8">Authorized dealer for the full Ferris lineup — Collins, Mississippi.</p>
