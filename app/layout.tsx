      ...
      <body className="min-h-screen flex flex-col bg-white text-gray-900 overflow-x-hidden">
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1199932965362268&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <Navbar />
        {/* Site-wide pricing banner — rebate disclosure only */}
        <div className="bg-black text-white border-b border-gray-800 py-2 text-center text-xs sm:text-sm tracking-wide">
          <span className="text-gray-400">Manufacturer instant rebates already included where shown · Call <a href="tel:6019095380" className="underline text-white">(601) 909-5380</a> for additional package savings</span>
        </div>
