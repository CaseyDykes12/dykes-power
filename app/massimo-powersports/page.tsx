...
export const metadata: Metadata = {
  title: 'Massimo Powersports — Coming Soon | Dykes Motors Power Equipment',
  description:
    'Dykes Motors is now an authorized Massimo Powersports dealer in Collins, Mississippi. Check back soon for inventory and announcements.',
    ...
    <div className="bg-[#0f0f0f] min-h-screen text-white flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center py-24">
        ...
        <p className="text-gray-300 text-lg leading-relaxed mb-8">
          We are excited to announce that Dykes Motors is now an Authorized Massimo Powersports Dealer. Check back soon for product listings and further announcements!
        </p>
