    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <section className="mb-10">
        <p className="text-gray-300">
          ...
          <a href="tel:6016415475" className="text-white underline">(601) 641-5475</a> for a quote.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-300">
          ...
          <a href="tel:6016415475" className="text-white underline">(601) 641-5475</a>. We're happy to help you pick the right machine the first time.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-300">
          <li>Contact us within 7 days at <a href="tel:6016415475" className="text-white underline">(601) 641-5475</a> or <a href="mailto:info@dykesmotors.com" className="text-white underline">info@dykesmotors.com</a></li>
      ...
      <section className="mb-10">
        ...
        <ul className="space-y-3 text-gray-300">
          ...
          <li>
            <span className="font-semibold text-white">Local delivery:</span> Available for a fee within the Collins/Hattiesburg area. Call (601) 641-5475 for a quote.
          </li>
          <li>
